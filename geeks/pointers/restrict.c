...
//telling compiler that ptr only way to access object pointed by it.
void use(int* a, int* b, int* restrict c)
{
	*a += *c;

	// Since c is restrict, compiler will not reload value at address c in its assembly code. Therefore generated
