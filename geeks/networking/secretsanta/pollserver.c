            ...
            if (pfds[i].revents & POLLIN) { // We got one!!
                ...
                if (pfds[i].fd == listener) {
                    ...
                    if (nbytes <= 0) {
                        ...
                        /*
                            if first number of buffer is 1. check if this pfdi exists in our user list
                            send back user already exists else create struct and add to user list
                            [5, 1, J, O, H, N] get length
                            allocate buffer get packet structure from id
                            use body somehow
                            "1john"
                            1 john
                            strfunc(1john, int *a, char *ogn)
                            "2"
                            "3"
                            2triggered = 0;
                        */        
